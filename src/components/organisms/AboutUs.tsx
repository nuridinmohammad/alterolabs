...
export function AboutUs() {
  return (
    <>
      ...
      <OurVision />
      <OurOffice />
      <div className="md:items-center w-full h-auto px-4 sm:px-10 py-20 flex-col justify-start items-start gap-10 inline-flex">
        <div className="md:max-w-[1180px]">
          <FaqHeading />
          <div className="w-full h-auto flex-col justify-start items-start gap-4 inline-flex mt-10">
            <FaqCard
