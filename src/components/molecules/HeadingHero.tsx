...
export function HeadingHero() {
  return (
    <div className="w-full h-auto flex px-4 py-10 flex-col items-start gap-4">
      <h1 className="items-stretch w-full h-auto font-parabolica text-[42px] not-italic font-bold leading-[50px] text-[#222230]">
